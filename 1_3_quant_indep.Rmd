...
Download and read the `hta.xlsx` data following script, keeping only cases with at least one BP measurement and complete data for sex and total cholesterol:
